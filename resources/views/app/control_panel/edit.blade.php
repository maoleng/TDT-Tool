...
@section('content')
    <form action="{{route('control_panel.update', ['template' => $template])}}" id="form" method="post" class="intro-y col-span-12 lg:col-span-6">
        ...
        <div class="intro-y box">
            ...
            <div id="basic-select" class="p-5">
                ...
                <div class="text-right mt-5">
                    <a href="{{route('index')}}" type="button" class="btn btn-outline-secondary w-24 mr-1">Hủy</a>
