                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                            <div class="report-box zoom-in">
                                <div class="box p-5">
                                    <div class="flex">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" icon-name="activity" data-lucide="activity" class="lucide lucide-activity report-box__icon text-primary"><circle cx="9" cy="21" r="1"></circle><circle cx="20" cy="21" r="1"></circle><path d="M1 1h4l2.68 13.39a2 2 0 002 1.61h9.72a2 2 0 002-1.61L23 6H6"></path></svg>
                                    </div>
...
console.log(data)
                    ...
                    // Biểu đồ thống kê
                    mailByMonths(data, background_color, border_color, options)
                    mailByDays(data, background_color, border_color, options)
                    usersReceiveMail(data, background_color, border_color, options)
                }
            });
        })
    })

    function mailByMonths(data, background_color, border_color, options)
    {
    ...
    function mailByDays(data, background_color, border_color, options)
    {
        const data_chart_mails_by_day = {
            labels: [1, 2, 3, 4, 5, 6, 7].map(function (day) {return 'Thứ ' + day}),
            datasets: [{
    ...
    function usersReceiveMail(data, background_color, border_color, options)
    {
